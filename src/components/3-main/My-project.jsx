 export  const MyProjects = [
   {
     ...
     imgPath: "public/Mos-modified.png",
   },
   {
     projectTitle: "html & css Project",
     cattegory: ["html-css", "react"],
     imgPath: "public/arrow-up.svg",
   },
   {
     projectTitle: "To-Do-List",
     cattegory: ["html-css", "js"],
     imgPath: "public/TO_DO_list.png",
   },
   {
     projectTitle: "Age Calculator App",
     cattegory: ["html-css", "js"],
     imgPath: "public/Calc-Age -App.png",
   },
   {
     projectTitle: "Generate a Random Password",
     cattegory: ["html-css", "js"],
     imgPath: "public/Generate a Random Passwordpng.png",
   },
 ];
